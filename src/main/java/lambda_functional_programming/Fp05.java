...
public class Fp05 {
    public static void main(String[] args) {
        ...
        System.out.println("checkAvgScoresToBeGreaterThanGivenNumber :" +checkAvgScoresToBeGreaterThanGivenNumber(coursesList,92));
        System.out.println(checkIfAnyCourseContainsGivenWord(coursesList,"Turkish"));
        System.out.println(getCourseNameWhoseAvgIsTheHightst(coursesList));
        System.out.println(sortCourseWithAvgScoreInAscendingOrderSkipFirtGiven(coursesList,3));
    }
...
public static String getCourseNameWhoseAvgIsTheHightst(List<Courses> list){
        return list.stream().
...
public static List<Object> sortCourseWithAvgScoreInAscendingOrderSkipFirtGiven(List<Courses> list,long num){

...
public class Day08StringManipulation01 {
    public static void main(String[] args) {
        //If your code gives correct output some data and it doesn't give correct data for some others
        ...
        //Example 5
        //Count how many character different from space were used in a String
                //1.Way
        String s="Tom Hanks was born in 1975.";
        int numberOfChars=s.replace(" ","").length();
